...
import { PgClient } from "./rust-core/database/drivers/postgres/ts-src/pgClient.ts";
import { PgManager } from "./rust-core/database/drivers/postgres/ts-src/pgManager.ts";
import { QueryResult } from "./rust-core/database/drivers/postgres/ts-src/queryResult.ts";
...
//         })), 
//         encode.encode(JSON.stringify({
//             statement: `INSERT INTO public.users VALUES (112323, 'asdasdasd', '$20'); INSERT INTO public.users VALUES (12113, 'asdasdasd', '$20')`,
//             parameters: ["1000"]
//         })));
...
let manager: PgManager = new PgManager({
  host: "127.0.0.1",
  username: "postgres",
  password: "Changeme1",
  dbname: "mandarine",
...
let x = await new PgClient(manager).query("SELECT * FROM users");
console.log(x.rowsToObjects());