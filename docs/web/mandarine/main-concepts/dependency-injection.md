...
```typescript
import { Service, Inject } from "https://x.nest.land/MandarineTS@1.4.0/mod.ts";
...
```typescript
import { Service, Configuration Injectable } from "https://x.nest.land/MandarineTS@1.4.0/mod.ts";
