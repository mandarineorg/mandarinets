...
```typescript
import { Service, Inject } from "https://deno.land/x/mandarinets@v2.1.5/mod.ts";
...
```typescript
import { Service, Configuration Injectable } from "https://deno.land/x/mandarinets@v2.1.5/mod.ts";
