...
```typescript
import { Service, Inject } from "https://x.nest.land/MandarineTS@1.2.1/mod.ts";
...
```typescript
import { Service, Configuration Injectable } from "https://x.nest.land/MandarineTS@1.2.1/mod.ts";
