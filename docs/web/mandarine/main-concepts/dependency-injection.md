...
```typescript
import { Service, Inject } from "https://deno.land/x/mandarinets@v2.1.1/mod.ts";
...
```typescript
import { Service, Configuration Injectable } from "https://deno.land/x/mandarinets@v2.1.1/mod.ts";
