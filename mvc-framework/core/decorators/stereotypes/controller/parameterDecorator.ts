...
export const Param = (paramType: DI.InjectionTypes): Function => {
    return (target: Object, methodName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(paramType, target, methodName, index);
    };
};
...
export const RouteParam = (name?: string): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.ROUTE_PARAM, target, propertyName, index, name);
    };
};
...
export const QueryParam = (name?: string): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.QUERY_PARAM, target, propertyName, index, name);
    };
};
...
export const RequestParam = (): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.REQUEST_PARAM, target, propertyName, index);
    };
};
...
export const Session = (): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.SESSION_PARAM, target, propertyName, index);
    };
};
...
export const ServerRequestParam = (): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.SERVER_REQUEST_PARAM, target, propertyName, index);
    };
};
...
export const ResponseParam = (): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.RESPONSE_PARAM, target, propertyName, index);
    };
};
...
export const CookieParam = (name?: string): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.COOKIE_PARAM, target, propertyName, index, name);
    };
};
...
export const RequestBody = (): Function => {
    return (target: Object, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.REQUEST_BODY_PARAM, target, propertyName, index);
    };
};
 ...
 */
 ...
 export const Model = (): Function => {
     return (target: any, propertyName: string, index: number) => {
        MVCDecoratorsProxy.registerRoutingParam(DI.InjectionTypes.TEMPLATE_MODEL_PARAM, target, propertyName, index);
     }
 }