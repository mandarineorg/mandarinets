...
export class RenderEngine {
    public static render(templatePath: string, engine: Mandarine.MandarineMVC.TemplateEngine.Engines, model: any): string {
        ...
        let template: Mandarine.MandarineMVC.TemplateEngine.Template = templatesManager.getTemplate(templatePath);
